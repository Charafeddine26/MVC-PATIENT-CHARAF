package com.charaf.patientsmvc.sec.service;

import com.charaf.patientsmvc.sec.entities.AppRole;
import com.charaf.patientsmvc.sec.entities.AppUser;
import com.charaf.patientsmvc.sec.repositories.AppRoleRepository;
import com.charaf.patientsmvc.sec.repositories.AppUserRepository;
...
public class SecurityServiceImpl implements SecurityService {
    ...
    public AppUser saveNewUser(String username, String password, String rePassword) {
        if(!password.equals(rePassword)) throw new RuntimeException("Passwords " +
                "dont match");
