package com.charaf.patientsmvc.sec;

import com.charaf.patientsmvc.sec.service.UserDetailsServiceImpl;
...
*/
        /*auth.jdbcAuthentication().dataSource(datasource)
                .usersByUsernameQuery("select username as principal" +
                        ", password as credentials, active from user where username=?")
                .authoritiesByUsernameQuery("select username as principal, role as role from " +
                        "user_roles where username=?").rolePrefix("ROLE_")
